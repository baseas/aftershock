...
extern vec4_t		colorMenuText;
extern vec4_t		colorOrange;
extern vec4_t		colorBanner;
extern vec4_t		colorListbar;
extern vec4_t		colorTextDisabled;
extern vec4_t		colorTextNormal;
extern vec4_t		colorTextHighlight;
