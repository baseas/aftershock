...
void CL_InitRenderer( void ) {
	...
	// load character sets
	cls.charSetShader = re.RegisterShader( "gfx/font/bigchars" );
	cls.whiteShader = re.RegisterShader( "white" );
	cls.consoleShader = re.RegisterShader( "console" );
	g_console_field_width = cls.glconfig.vidWidth / SMALLCHAR_SIZE - 2;
...
void CL_Init( void ) {
	...
	cl_yawspeed = Cvar_Get ("cl_yawspeed", "140", CVAR_ARCHIVE | CVAR_CHEAT);
	cl_pitchspeed = Cvar_Get ("cl_pitchspeed", "140", CVAR_ARCHIVE | CVAR_CHEAT);
